...
class LIGNex1_Demo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.plasma_bae_sink_0_0_0_0_0 = plasma.bae_sink(samp_rate, 128, center_freq_1, None, 0)
        ...
        self.plasma_bae_sink_0_0_0_0 = plasma.bae_sink(samp_rate, 128, center_freq_2, None, 0)
        ...
        self.plasma_bae_sink_0_0 = plasma.bae_sink(samp_rate, 128, center_freq_4, None, 0)
        ...
        self.plasma_bae_sink_0 = plasma.bae_sink(samp_rate, 128, center_freq_5, None, 0)
        ...
        self.msg_connect((self.plasma_signal_processing_0_0, 'out'), (self.plasma_bae_sink_0_0, 'in'))
        ...
        self.msg_connect((self.plasma_signal_processing_0_2, 'out'), (self.plasma_bae_sink_0_0_0_0, 'in'))
        self.msg_connect((self.plasma_signal_processing_0_2, 'out'), (self.plasma_spectro_sink_0_2, 'in'))
        self.msg_connect((self.plasma_signal_processing_0_3, 'out'), (self.plasma_bae_sink_0_0_0_0_0, 'in'))
