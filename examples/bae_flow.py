...
class bae_flow(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_freq_sink_x_0.set_update_time(0.00010)
        ...
        self.plasma_signal_processing_0 = plasma.signal_processing(1024,samp_rate,0,1,2, 0)


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.plasma_signal_processing_0, 'time'), (self.qtgui_time_sink_x_0, 'in'))
