...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.plasma_pdu_file_sink_1 = plasma.pdu_file_sink(gr.sizeof_gr_complex,'output.bin', 'output_meta.bin')


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.pluto_source_bae_0, 'out'), (self.plasma_pdu_file_sink_1, 'in'))
