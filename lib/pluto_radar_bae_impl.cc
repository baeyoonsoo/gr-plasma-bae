...
pluto_radar_bae::sptr pluto_radar_bae::make(const std::string& args,
                                  ...
                                  const bool verbose)
{
    return gnuradio::make_block_sptr<pluto_radar_bae_impl>(args,
                                                      tx_rate,
                                                      rx_rate,
                                                      tx_freq,
                                                      rx_freq,
...
pluto_radar_bae_impl::pluto_radar_bae_impl(const std::string& args,
                                 const double tx_rate,
                                 const double rx_rate,
                                 const double tx_freq,
                                 const double rx_freq,
                                 ...
                                 const bool verbose)
    : gr::block(
          "pluto_radar_bae", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0)),
      usrp_args(args),
      tx_rate(tx_rate),
      rx_rate(rx_rate),
      tx_freq(tx_freq),
...
void pluto_radar_bae_impl::config_usrp(uhd::usrp::multi_usrp::sptr& usrp,
...
void pluto_radar_bae_impl::receive(uhd::usrp::multi_usrp::sptr usrp,
...
void pluto_radar_bae_impl::transmit(uhd::usrp::multi_usrp::sptr usrp,
...
void pluto_radar_bae_impl::read_calibration_file(const std::string& filename)
{
...
void pluto_radar_bae_impl::set_metadata_keys(const std::string& tx_freq_key,
