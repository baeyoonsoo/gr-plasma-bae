...
#ifndef INCLUDED_PLASMA_PLUTO_RADAR_BAE_IMPL_H
#define INCLUDED_PLASMA_PLUTO_RADAR_BAE_IMPL_H
...
public:
    pluto_radar_bae_impl(const std::string& args,
                    const double tx_rate,
                    const double rx_rate,
                    const double tx_freq,
                    const double rx_freq,
...
#endif /* INCLUDED_PLASMA_PLUTO_RADAR_BAE_IMPL_H */